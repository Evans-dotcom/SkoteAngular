...
import { MajorMaintenance, MajorMaintenanceService } from './major-maintenance.service';

@Component({
  selector: 'app-major-maintenance',
  templateUrl: './major-maintenance.component.html',
  styleUrls: ['./major-maintenance.component.scss']
})
export class MajorMaintenanceComponent implements OnInit {
  records: MajorMaintenance[] = [];
  selected: MajorMaintenance = this.emptyForm();
  isEdit = false;
  ...
  constructor(private service: MajorMaintenanceService) {}
