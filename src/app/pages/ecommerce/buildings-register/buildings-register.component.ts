...
import { BuildingsRegister, BuildingsRegisterService } from './building-register.service';

@Component({
  selector: 'app-buildings-register',
  templateUrl: './buildings-register.component.html',
  styleUrls: ['./buildings-register.component.scss']
})
export class BuildingsRegisterComponent implements OnInit {
  buildings: BuildingsRegister[] = [];
  selected: BuildingsRegister = this.emptyForm();
  isEdit = false;
  ...
  constructor(private service: BuildingsRegisterService) {}
